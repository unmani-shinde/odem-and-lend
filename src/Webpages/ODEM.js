  ...
  const toggleLearningExperienceAvailability = async (id) => {
    try {
      ...
      <div className="container2">
        <div >
        <h1>Learning Experiences</h1><br/>
        <button className="LowerButton" style={{marginLeft:'90px'}} onClick={createLearningExperience}>Create Learning Experience</button>
        <table>
        <thead>
        <tr>
        <th>ID</th>
        ...
        <button className="LowerButton" style={{marginTop:'300px'}}onClick={bookLearningExperience}>Book A Learning Experience</button>
        <button className="LowerButton" onClick={()=>navigate("/")}>Home</button>
        <button className="LowerButton" onClick={()=>navigate("/borrower")}>Raise Funds</button>        
      </div>
      );
      }
